...
public class UserController {
    ...
    @GetMapping("/my-point")
    public ResponseEntity<ApiResponse<Integer>> getMyPoint(@SessionAttribute(name = LOGIN_USER) int userId) {
        int point = getMyPointFacade.getMyPoint(userId);
        return new ResponseEntity<>(ApiResponse.success(point), HttpStatus.OK);
    }
